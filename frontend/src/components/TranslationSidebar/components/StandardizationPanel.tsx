...
interface StandardizationPanelProps {
  ...
  onApplyStandardization: () => void;
  onStopStandardization?: () => void;
  onRetryInconsistencyAnalysis?: () => void;
  variant?: "inline" | "full";
  currentProcessingIndex?: number; // For tracking which item is being updated
  scrollContainerRef?: React.RefObject<HTMLDivElement | null>;
}

const StandardizationPanel: React.FC<StandardizationPanelProps> = ({
  inconsistentTerms,
