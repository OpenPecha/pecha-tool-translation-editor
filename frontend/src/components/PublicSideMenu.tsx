...
import { MessageSquare, FileText, Languages, Eye } from "lucide-react";
import { Button } from "@/components/ui/button";
import { IoIosArrowForward } from "react-icons/io";
import { ScrollArea } from "@/components/ui/scroll-area";
import AvatarWrapper from "@/components/ui/custom-avatar";
import { useQuery } from "@tanstack/react-query";
import { fetchPublicDocumentTranslations } from "@/api/document";
import { fetchPublicComments } from "@/api/comment";
import { fetchPublicFootnotes } from "@/api/footnote";
...
function PublicTranslations({
  ...
  const {
    ...
    queryKey: ["public-translations", documentId],
