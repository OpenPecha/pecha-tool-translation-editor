...
const ProjectTemplates = () => {
  ...
  const createProjectMutation = useMutation({
    mutationFn: async (template: TemplateData) => {
      ...
      const documentName = template.title || `OpenPecha-${template.expression_id}`;
         ...
         <div className="flex gap-4 h-full">
          {templateData.map((template: TemplateData) => {
            ...
            return (
              ...
              >
                <div className="space-y-2">
                  <div className={`border border-border/50 hover:shadow-lg transition-all duration-300 overflow-hidden h-[180px]  bg-neutral-50 dark:bg-neutral-700 ${
