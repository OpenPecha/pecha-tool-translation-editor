      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <p className="text-xs text-purple-800 leading-relaxed">
            {isExtractingGlossary
              ? t("glossaryChatbot.extractingGlossaryTerms")
              : t("glossaryChatbot.analyzingConsistency")}
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex items-start gap-2 mb-3">
        ...
        <div className="flex-1">
          <p className="text-xs text-neutral-800 dark:text-neutral-100 leading-relaxed">
            ...
            {t("glossaryChatbot.foundTranslations", {
              count: translationResults.length,
            })}{" "}
            {t("glossaryChatbot.extractGlossaryQuestion")}
          </p>
        </div>
      </div>
