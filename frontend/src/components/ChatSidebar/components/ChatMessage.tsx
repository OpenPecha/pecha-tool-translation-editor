  ...
  const getMessageStyles = () => {
    if (isUser) {
      return {
        ...
        bubble:
          " bg-blue-500 text-white rounded-lg rounded-br-sm px-2 py-1 shadow-sm",
    ...
    if (isError) {
      return {
        ...
        bubble:
          "max-w-full bg-red-50 border border-red-200 text-red-800 rounded-lg rounded-bl-sm px-4 py-2 shadow-sm",
    ...
    return {
      container: "flex justify-start mb-4",
      bubble: "max-w-full  text-gray-800 dark:text-gray-200  rounded-bl-sm  ",
