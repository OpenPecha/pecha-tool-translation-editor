...
const DisplaySettings: React.FC<{}> = ({}) => {
	...
	const TypographyControl: React.FC<{
		...
		onUpdate: <K extends keyof TypographySettings>(
			key: K,
			...
			<div className="space-y-3 p-3  border border-neutral-100 dark:border-neutral-700 rounded-lg">
				...
				<div className="space-y-3">
					...
					<div>
						...
						<div className="flex items-center space-x-2">
							<Button
								...
								onClick={() =>
									onUpdate("fontSize", Math.max(0.8, typography.fontSize - 0.1))
								}
							...
							<Button
								...
								className="h-6 w-6 p-0"
								onClick={() =>
									onUpdate("fontSize", Math.min(2.0, typography.fontSize + 0.1))
								}
					...
					<div>
						<div className="flex items-center justify-between mb-1">
							<span className="text-xs text-neutral-500 dark:text-neutral-400">
								{t("settings.lineHeight", "Line Height")}
							</span>
							<span className="text-xs text-neutral-400 dark:text-neutral-500 font-mono">
