...
class CollapsibleFootnoteSection extends FootnoteSection {
	constructor(scroll: any, domNode: HTMLElement, value: any) {
		...
		if (!domNode.querySelector(".footnote-toggle")) {
			...
			header.className =
				"footnote-toggle bg-neutral-100 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-600";
			...
			observer.observe(domNode.parentNode || document.body, {
				childList: true,
			});
