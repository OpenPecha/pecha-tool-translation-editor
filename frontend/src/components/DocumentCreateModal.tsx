...
function DocumentCreateModal({ documents, setShowCreateModal }: { documents: Document[], setShowCreateModal: (show: boolean) => void }) {
  ...
  return (
    ...
    <div className="bg-white  rounded-lg w-full max-w-md shadow-lg">
      <div className="p-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <button className="text-gray-500 hover:text-gray-700 text-xl" onClick={() => setShowCreateModal(false)}>
          &times;
        </button>
      </div>
      <div className="p-4">
        <div className="mb-4">
          <label htmlFor="docIdentifier" className="block mb-1">Document Identifier</label>
          <input
            type="text"
            id="docIdentifier"
        ...
        {!isRoot && (
          <div className="mb-4">
            ...
            >
              ...
              {documents.filter(d => d.isRoot).map(d => (
        ...
        <div className="mb-4">
          <label htmlFor="fileInput" className="block mb-1">Upload File (Optional)</label>
          <input
            type="file"
            id="fileInput"
            ref={fileInputRef}
