...
function RenderTranslationEditor({ translations }: { translations: Translation[] }) {
  ...
  if (!selectedTranslationId) return <div className="translation-selector p-4 bg-gray-100">
  <label htmlFor="translationSelect" className="mr-2">Select Translation:</label>
  <select
