export type TimeCategory = "today" | "yesterday" | "last7Days" | "previous30Days" | "earlier";
 ...
 */
export function formatDateByCategory(date: string, category: TimeCategory): string {
 ...
 */
export function categorizeProjectsByTime(projects: any[]): CategorizedProject[] {
  ...
  const categoryOrder: TimeCategory[] = ["today", "yesterday", "last7Days", "previous30Days", "earlier"];
 ...
 */
export function getUniqueOwners(projects: any[]): Array<{ id: string; username: string }> {
